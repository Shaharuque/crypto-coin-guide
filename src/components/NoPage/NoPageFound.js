        ...
        <div className='grid items-center w-full grid-cols-1 gap-10 mx-auto md:w-4/5 lg:grid-cols-2 xl:gap-32'>
          <div>
            ...
            <p className='mb-5 text-base text-left text-gray-800 md:text-xl'>
              You might have entered wrong url or link might be broken. Try again later!!
            </p>
            <Link
              to='/'
              className='w-full mb-2 py-2 px-3 text-white mt-3 bg-cyan-600 hover:bg-rose-600 sm:w-auto sm:mb-0 rounded-lg '
            >
              Back to homepage
            </Link>
            <Link
              to='/contact'
              className='w-full mb-2 py-2 px-3 text-white mt-3 mx-2 bg-cyan-600 hover:bg-rose-600  sm:w-auto sm:mb-0 rounded-lg'
            >
              Contact us
            </Link>
          </div>
